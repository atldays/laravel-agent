...
{
    public function test_facade_detect_returns_explicit_agent(): void
    {
        $agent = AgentFacade::detect('Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)');

        $this->assertInstanceOf(Agent::class, $agent);
        $this->assertSame('Googlebot', $agent->bot()?->name());
    }

    public function test_facade_proxies_to_current_request_agent(): void
    {
